...
class GP2LM:
    ...
    def __init__(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained("../common/gpt2-persian")
        self.model = AutoModelWithLMHead.from_pretrained("../common/gpt2-persian",gradient_checkpointing=True)
