...
class VerbHandler():
    ...
    #     with open(self.verb_addr, encoding='utf-8') as f:
    #         return [{k:v  for k,v in zip(['past', 'present'], line.split('#')) } for line in f.read().splitlines()]
    #
    # def _load_mapper(self):
    #     mapper = {}
    #     with open(self.verb_map_addr, encoding='utf-8') as f:
    ...
    #                 formality = l
    #                 tense = 'present'
    #             formal, informal = formality.split('#')
    #             mapper[informal] = {'formal': formal, 'tense': tense}
    #         return mapper
    #
    # # def is_verb(self, word):
    # #     res = self.parse(word)
    # #     if res is None or res['root'] == "":
    # #         return False
    # #     return True
    #
    # def is_verb(self, word):
    #     match_dict = self.parse(word)
    #     match_dict = self._set_match_dict_prefix(match_dict)
    #     if (match_dict['root'] == 'ا' and match_dict['prefix'] == 'ب') or match_dict['root'] == '' or self.if_simple_present(match_dict) or (match_dict['tense'] =='present' and 'می' in match_dict['prefix'] and match_dict['postfix'] == ''):
    #         return False
    #     return True
    #     # return res['tense'] == 'past' and res['root'] in self.formal_past_bons or res['tense'] == 'present' and res['root'] in self.formal_present_bons
    #
    # def is_formal_verb(self, word):
    #     return word in self.all_formal_verbs
    ...
    # import pandas as pd
    # print(vb.informal_to_formal('میدونه'))
    # print(vb.informal_to_formal('میدونه'))
    # print(vb.informal_to_formal('می‌گنجن'))
    # print(vb.informal_to_formal('ببوسن'))
    # print(vb.informal_to_formal('نمیبوسمش'))
    # print(vb.informal_to_formal('بده'))
    # print(vb.informal_to_formal('میاد'))
    # print(vb.informal_to_formal('میخوابن'))
    # print(vb.informal_to_formal('بخوان'))
    # print(vb.informal_to_formal('میخوانش'))
    # print(vb.informal_to_formal('شدن'))
    # print(vb.informal_to_formal('میشده'))
    # print(vb.informal_to_formal('بری'))
    # print(vb.informal_to_formal('نرم'))
    # print(vb.informal_to_formal('میکنن'))
    # print(vb.informal_to_formal('میبرنش'))
    # print(vb.informal_to_formal('میارنتون'))
    # print(vb.informal_to_formal('میدونن'))
    # print(vb.informal_to_formal('ندونن'))
    # print(vb.informal_to_formal('بزارن'))
    # print(vb.informal_to_formal('بخوابیم'))
    # print(vb.informal_to_formal('بخوابانیمش'))
    # print(vb.informal_to_formal('بخوابونیمش'))
    # print(vb.informal_to_formal('اوردنت'))
    # print(vb.informal_to_formal('میره'))
    # print(vb.informal_to_formal('میره'))
    # print(vb.informal_to_formal('میریزه'))
    # print(vb.informal_to_formal('میخاراند'))
    # print(vb.informal_to_formal('نیستم'))
    # print(vb.informal_to_formal('ایستادن'))
    # print(vb.informal_to_formal('ایستادن'))
    # print(vb.informal_to_formal('است'))
    # print(vb.informal_to_formal('نجو'))
    # print(vb.informal_to_formal('رفته‌ام'))
    # mapper = {'☓': False, '✓':True}
    # lines= open('resources/wiki_verbs.txt').read().splitlines()
    # cols = lines[0].split('\t')
    # cols.extend(['پیشوند', 'گذشته محاوره', 'حال محاوره'])
    # data = []
    # presents, pasts = {}, {}
    # for index, line in enumerate(lines[1:]):
    #     row = [item  if item not in mapper else mapper[item] for item in line.split('\t')]
    #     row.append('')
    #     row.append('')
    #     row.append('')
    #     if row[2]:
    #         presents[row[2]] = index
    #     if row[1]:
    #         pasts[row[1]] = index
    #     data.append(row)
    # mapper_verbs = vb._load_mapper()
    # for inf_verb in mapper_verbs:
    #     if mapper_verbs[inf_verb]['tense'] == 'present' and  mapper_verbs[inf_verb]['formal'] in presents:
    #         data[ presents[mapper_verbs[inf_verb]['formal'] ]][-1] += (' ' + inf_verb)
    #     if mapper_verbs[inf_verb]['tense'] == 'past' and  mapper_verbs[inf_verb]['formal'] in pasts:
    #         data[ pasts[mapper_verbs[inf_verb]['formal'] ]][-2] += (' ' + inf_verb)
    #
    # for item in data:
    #     if item[-1] != '' or item[-2]:
    #         print(item)
